    ...
    <section className="qualification section">
      ...
      <div className="qualification_container container">
        <div className="qualification_tabs">
          <div className={toggleState === 1 ? "qualification_buttons qualification_active button--flex" : "qualification_buttons button--flex"} onClick={() => toggleTab(1)}>
            <i className="uil uil-graduation-cap qualification_icon"></i>
            Education
          </div>

          <div className={toggleState === 2 ? "qualification_buttons qualification_active button--flex" : "qualification_buttons button--flex"} onClick={() => toggleTab(2)}>
